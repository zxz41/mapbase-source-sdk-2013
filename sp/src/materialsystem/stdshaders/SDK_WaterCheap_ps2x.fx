...
float4 main( PS_INPUT i ) : COLOR
{
	...
	float fogFactor = CalcRangeFogFactorNonFixedFunction( i.vWorldPos, g_EyePos, g_PixelFogParams.z, g_PixelFogParams.x, g_PixelFogParams.w );
#else
	float fogFactor = 0;
#endif
